...
# Open figure and set axes
plt.close('all')
#fig, ax = plt.subplots(2,1,figsize=(8,6))
fig = plt.figure()
fig.canvas.set_window_title('ServiceProv2a')
#plt.subplot(2,1,1)
...
# Add Input checkbox
#axCh = plt.axes([.45,.55,.1,.1])
axCh = plt.subplot2grid((3,2),(1,1))
...
# Add Input slider
#axSl = plt.axes([0.15, 0.4, 0.3, 0.1])
axSl = plt.subplot2grid((3,2),(1,0))
